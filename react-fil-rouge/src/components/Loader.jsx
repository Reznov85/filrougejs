...
const Loader = ({ size = "w-8 h-8", box = "w-56 h-56" }) => {
  return (
    <div
      className={`flex items-center justify-center ${box} border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700`}
    >
      <div role="status">
        <svg
          aria-hidden="true"
